...
jQuery.addcat = function() {
    $('#total-form #catin :selected').each(function() {
        $(this).remove();
        $('#total-form #catout').append('<option value="' + $(this).attr('value') + '">' + $(this).text() + '</option>');
        $('#total-form #area-cats input[value=\'' + $(this).attr('value') + '\']').remove();
        $('#total-form #area-cats').append('<input type="hidden" name="subcat[]" value="' + $(this).attr('value') + '" />');

    });
}
jQuery.delcat = function() {
    $('#total-form #catout :selected').each(function() {
        $('#total-form #area-cats input[value=\'' + $(this).attr('value') + '\']').remove();
        $(this).remove();
        $('#total-form #catin').append('<option value="' + $(this).attr('value') + '">' + $(this).text() + '</option>');
    });
}
