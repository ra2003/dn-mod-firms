...
$inq = $db->query
		(
			"SELECT a.id, a.catid, a.public, a.stpublic, a.unpublic, a.cpu, a.title, a.textshort, a.textmore, a.image_thumb, a.image_alt, a.act, a.pid, b.catname, b.catcpu, b.rss
			 FROM ".$basepref."_".WORKMOD." AS a
			 LEFT JOIN ".$basepref."_".WORKMOD."_cat AS b ON (a.catid = b.catid)
			 WHERE ((a.act = 'yes' AND b.rss = 'yes') OR (a.act = 'yes' AND a.catid = 0)) AND a.pid = '0'
